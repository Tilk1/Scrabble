...
for x in range(10):
    row = []
    for y in range(10):
        row.append(sg.RButton('', image_filename=random.choice(vacios), border_width=0, image_size=(
            50, 50), size=(50, 50), pad=(0, 0), key=(x, y)))  # el filename no funciona
    tablero.append(row)

bolsa = {'A.png': {'cant': 11, 'valor': 1},
         'B.png': {'cant': 11, 'valor': 3},
         'C.png': {'cant': 8, 'valor': 1},
         'D.png': {'cant': 7, 'valor': 1},
         'E.png': {'cant': 7, 'valor': 1},
         'F.png': {'cant': 7, 'valor': 1},
         'G.png': {'cant': 7, 'valor': 1},
         'H.png': {'cant': 5, 'valor': 1},
